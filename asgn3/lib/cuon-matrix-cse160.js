...
class Vector3 {
    ...
    static cross(other1, other2) {
        //A × B = (bz – cy)[0] – (az – cx)[1] + (ay – bx)[2] = (bz – cy)i + (cx – az)j + (ay – bx)k
        // other 1 = A B C
        // other 2 = X Y Z
        // Insert your code here.
    ...
    magnitude() {
        ...
        //what is magnitude!? Lol
        // magnitude is sqrt(all forces in x squared + all forces in y squared)
        // but since we do this for 1 vector its just the elements forces we will use
        // let lets us do variable definitions in 1 line so no more redefine variables
        for (let i = 0; i < 3; ++i) {
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        // need to store magnitude because it changes as we do the loop
